---
title: "Zap.md Recipe Format: Fields, Inputs, and Validation Rules"
sidebarTitle: "Zap Spec"
description: "Zap.md combines YAML frontmatter with Markdown prose. Learn every required field, input type, step reference, and validation rule."
---
