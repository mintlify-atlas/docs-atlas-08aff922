---
title: "Zap CLI Commands: Complete @wzrdtech/zap Reference Guide"
sidebarTitle: "CLI Commands"
description: "Complete reference for all 16 zap commands: init, new, validate, lint, run, status, dev, studio, add, docs, skills, doctor, info, upgrade, and more."
---
