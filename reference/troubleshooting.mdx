---
title: "Troubleshooting Common Zap Issues"
sidebarTitle: "Troubleshooting"
description: "Solutions for the most common Zap problems: Node version errors, recipe validation failures, live run rejections, Supabase secret issues, and HyperFrames fallbacks."
---
...
| `upstash` | Upstash REST env configured (`UPSTASH_REDIS_REST_URL` + `UPSTASH_REDIS_REST_TOKEN`) |
| `supabase` | Supabase public env configured (`NEXT_PUBLIC_SUPABASE_URL` + key) |
