---
title: "Get Started with Zap in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Scaffold a Zap project, author your first recipe, validate it, and run a zero-cost mock pipeline — all from the command line."
---
