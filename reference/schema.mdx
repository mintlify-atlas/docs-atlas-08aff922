---
title: "Zap Recipe Schema: Full Field Reference"
sidebarTitle: "Schema"
description: "Complete Zod-validated schema reference for Zap.md frontmatter — every field, type, default value, and constraint extracted from the @wzrdtech/core package."
---
...
// Strip the YAML frontmatter block from a Zap.md string.
