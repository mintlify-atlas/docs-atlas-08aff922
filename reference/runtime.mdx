...
description: "How Zap executes live pipelines: Convex run state, Upstash poll queues, provider adapters, poll draining, HyperFrames stitching, and BYOK key retrieval."
---
