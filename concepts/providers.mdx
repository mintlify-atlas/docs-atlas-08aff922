...
description: "Zap routes each pipeline step to the mock, GMI, fal, or BYOK adapter. Learn provider priority, required keys, and the seven supported secret types."
---
